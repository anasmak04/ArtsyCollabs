                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $userstatistic }}</div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Earnings (Annual)</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $projectstatistic }}</div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $partnerstatistic }}</div>
                                            </div>
                                            <div class="col">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($user->status == "pending")
                                                <span class="badge-status badge-pending">{{ $user->status }}</span>
                                            @elseif($user->status == "accepted")
                                                <span class="badge-status badge-accepted">{{ $user->status }}</span>
                                            @elseif($user->status == "refused")
                                                <span class="badge-status badge-refused">{{ $user->status }}</span>
                                            @endif
                                        </td>
                                        <td>
